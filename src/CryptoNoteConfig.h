...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x1f; // addresses start with "q"
...
const char     CRYPTONOTE_NAME[]                             = "Quadrivae";
...
const int      P2P_DEFAULT_PORT                              = 18100;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 18101;
